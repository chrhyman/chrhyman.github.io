...
execute as @a[x=455,y=75,z=-2127,dx=35,dy=22,dz=32] at @s run function mw2:sacrifice_game/pit/warn_turn_back

# if a player is inside the true kill zone, instantly kill them with magic
execute as @a[x=460,y=80,z=-2122,dx=25,dy=12,dz=22] at @s run function mw2:sacrifice_game/pit/kill_trespasser
